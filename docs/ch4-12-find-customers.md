...
![A clear proposal states the outcome, the scope, the price, and the timeline, so both sides start with the same expectations.](figure-4-12a.png)
...
![A client lifecycle moves from a first conversation through discovery and delivery to evidence and, when appropriate, a referral.](figure-4-12b.png) 
